...
from app.application.api.dependencies import get_location_repository
from app.infrastructure.use_cases.uc_location import CreateLocationUseCase, GetAllLocationsUseCase
